...
over a period of time. This rate limit does not apply to private repositories.

It is not intended that this rate limit should interfere with any legimate use of
the API, and we hope mistaken blocks are rare. Your normal [rate
limits](/v3/#rate-limiting) should be the only limits you target.

Please [contact support][support] if your use is affected by this rate limit.
...

{
  ...
  "documentation_url": "https://developer.github.com/v3/#content-creation-rate-limit",
  "errors": [
    {
      "resource": "IssueComment",
      "code": "custom",
      "message": "was submitted too quickly after a previous comment"
    }
  ]
}
<pre>
