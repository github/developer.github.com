...
To prevent abuse, additional rate limits apply to protect the quality of service of GitHub.
For example, creating content rapidly, polling aggressively instead of using [webhooks](/webhooks),
making API calls with a high concurrency, or requesting data that is computationally expensive
