...
rules](/v3/search/#rate-limit).) Requests are associated with your IP address,
and not any tokens you use.
...
If you're making unauthenticated calls as part of your OAuth application, you'll get a higher rate limit if you use your client ID and secret in the query string.
