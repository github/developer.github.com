...
`push` | Any Git push to a Repository, including editing tags or branches. Commits via the API that update references are also counted. **This is the default event.**
