...
To protect the quality of service of GitHub, additional rate limits may apply to some actions.
For example, rapidly creating content, polling aggressively instead of using [webhooks](/webhooks),
