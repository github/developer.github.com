...
In general, these links are provided as [URI templates](http://tools.ietf.org/html/rfc6570), even though most links don't include template expressions.

The possible `rel` values are:

Name | Description
-----------|-----------|
`next` |The URI template for the immediate next page of results.
`last` |The URI template for the last page of results.
`first` |The URI template for the first page of results.
`prev` |The URI template for the immediate previous page of results.
