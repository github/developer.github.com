...
`302`, `307` | Temporary redirection. The request should be repeated verbatim to the URI
...
`POST` | Used for creating resources, or performing custom actions (such as
...
POST requests.
`PUT` | Used for replacing resources or collections. For PUT requests
